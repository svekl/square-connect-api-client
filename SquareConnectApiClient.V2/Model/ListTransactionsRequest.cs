...
namespace SquareConnectApiClient.V2.Model
{
    ...
    { 
        ...
        /// </summary>
        /// <value>The order in which results are listed in the response (`ASC` for\nchronological, `DESC` for reverse-chronological).</value>
